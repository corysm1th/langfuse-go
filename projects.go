...
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *ProjectsCreateRequest) SetMetadata(metadata map[string]any) {
	p.Metadata = metadata
...
// SetMetadata sets the Metadata field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *Project) SetMetadata(metadata map[string]any) {
	p.Metadata = metadata
...
// SetMetadata sets the Metadata field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *ProjectsUpdateRequest) SetMetadata(metadata map[string]any) {
	p.Metadata = metadata
