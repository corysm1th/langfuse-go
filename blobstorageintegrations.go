...
var (
	blobStorageIntegrationsGetBlobStorageIntegrationStatusRequestFieldID = big.NewInt(1 << 0)
)

type BlobStorageIntegrationsGetBlobStorageIntegrationStatusRequest struct {
	ID string `json:"-" url:"-"`
...
func (b *BlobStorageIntegrationsGetBlobStorageIntegrationStatusRequest) require(field *big.Int) {
	if b.explicitFields == nil {
		b.explicitFields = big.NewInt(0)
	}
	b.explicitFields.Or(b.explicitFields, field)
...
// SetID sets the ID field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationsGetBlobStorageIntegrationStatusRequest) SetID(id string) {
	b.ID = id
	b.require(blobStorageIntegrationsGetBlobStorageIntegrationStatusRequestFieldID)
}
...
var (
	...
	blobStorageIntegrationResponseFieldCompressed      = big.NewInt(1 << 14)
	blobStorageIntegrationResponseFieldNextSyncAt      = big.NewInt(1 << 15)
	blobStorageIntegrationResponseFieldLastSyncAt      = big.NewInt(1 << 16)
	blobStorageIntegrationResponseFieldLastError       = big.NewInt(1 << 17)
	blobStorageIntegrationResponseFieldLastErrorAt     = big.NewInt(1 << 18)
	blobStorageIntegrationResponseFieldCreatedAt       = big.NewInt(1 << 19)
	blobStorageIntegrationResponseFieldUpdatedAt       = big.NewInt(1 << 20)
)
...
type BlobStorageIntegrationResponse struct {
	...
	Compressed      bool                           `json:"compressed" url:"compressed"`
	...
	LastErrorAt     *time.Time                     `json:"lastErrorAt,omitempty" url:"lastErrorAt,omitempty"`
...
func (b *BlobStorageIntegrationResponse) GetCompressed() bool {
	if b == nil {
		return false
	}
	return b.Compressed
...
func (b *BlobStorageIntegrationResponse) GetLastError() *string {
	if b == nil {
		return nil
	}
	return b.LastError
...
func (b *BlobStorageIntegrationResponse) GetLastErrorAt() *time.Time {
	if b == nil {
		return nil
	}
...
// SetCompressed sets the Compressed field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationResponse) SetCompressed(compressed bool) {
	b.Compressed = compressed
	b.require(blobStorageIntegrationResponseFieldCompressed)
}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationResponse) SetLastError(lastError *string) {
	b.LastError = lastError
	b.require(blobStorageIntegrationResponseFieldLastError)
}

// SetLastErrorAt sets the LastErrorAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationResponse) SetLastErrorAt(lastErrorAt *time.Time) {
	b.LastErrorAt = lastErrorAt
	b.require(blobStorageIntegrationResponseFieldLastErrorAt)
}
...
func (b *BlobStorageIntegrationResponse) UnmarshalJSON(data []byte) error {
	...
	var unmarshaler = struct {
		...
		LastErrorAt     *internal.DateTime `json:"lastErrorAt,omitempty"`
	...
	*b = BlobStorageIntegrationResponse(unmarshaler.embed)
	...
	b.LastErrorAt = unmarshaler.LastErrorAt.TimePtr()
...
func (b *BlobStorageIntegrationResponse) MarshalJSON() ([]byte, error) {
	...
	var marshaler = struct {
		...
		LastErrorAt:     internal.NewOptionalDateTime(b.LastErrorAt),
...
var (
	blobStorageIntegrationStatusResponseFieldID          = big.NewInt(1 << 0)
	blobStorageIntegrationStatusResponseFieldProjectID   = big.NewInt(1 << 1)
	blobStorageIntegrationStatusResponseFieldSyncStatus  = big.NewInt(1 << 2)
	blobStorageIntegrationStatusResponseFieldEnabled     = big.NewInt(1 << 3)
	blobStorageIntegrationStatusResponseFieldLastSyncAt  = big.NewInt(1 << 4)
	blobStorageIntegrationStatusResponseFieldNextSyncAt  = big.NewInt(1 << 5)
	blobStorageIntegrationStatusResponseFieldLastError   = big.NewInt(1 << 6)
	blobStorageIntegrationStatusResponseFieldLastErrorAt = big.NewInt(1 << 7)
)

type BlobStorageIntegrationStatusResponse struct {
	ID         string                `json:"id" url:"id"`
	ProjectID  string                `json:"projectId" url:"projectId"`
	SyncStatus BlobStorageSyncStatus `json:"syncStatus" url:"syncStatus"`
	Enabled    bool                  `json:"enabled" url:"enabled"`
...
func (b *BlobStorageIntegrationStatusResponse) GetID() string {
	if b == nil {
		return ""
	}
	return b.ID
...
func (b *BlobStorageIntegrationStatusResponse) GetProjectID() string {
	if b == nil {
		return ""
	}
	return b.ProjectID
...
func (b *BlobStorageIntegrationStatusResponse) GetSyncStatus() BlobStorageSyncStatus {
	if b == nil {
		return ""
	}
	return b.SyncStatus
...
func (b *BlobStorageIntegrationStatusResponse) GetEnabled() bool {
	if b == nil {
		return false
	}
	return b.Enabled
...
func (b *BlobStorageIntegrationStatusResponse) GetLastSyncAt() *time.Time {
	if b == nil {
		return nil
	}
	return b.LastSyncAt
...
func (b *BlobStorageIntegrationStatusResponse) GetNextSyncAt() *time.Time {
	if b == nil {
		return nil
	}
	return b.NextSyncAt
...
func (b *BlobStorageIntegrationStatusResponse) GetLastError() *string {
	if b == nil {
		return nil
	}
	return b.LastError
...
func (b *BlobStorageIntegrationStatusResponse) GetLastErrorAt() *time.Time {
	if b == nil {
		return nil
	}
	return b.LastErrorAt
...
func (b *BlobStorageIntegrationStatusResponse) GetExtraProperties() map[string]interface{} {
	if b == nil {
		return nil
	}
	return b.extraProperties
...
func (b *BlobStorageIntegrationStatusResponse) require(field *big.Int) {
	if b.explicitFields == nil {
		b.explicitFields = big.NewInt(0)
	}
	b.explicitFields.Or(b.explicitFields, field)
...
// SetID sets the ID field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetID(id string) {
	b.ID = id
	b.require(blobStorageIntegrationStatusResponseFieldID)
}

// SetProjectID sets the ProjectID field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetProjectID(projectID string) {
	b.ProjectID = projectID
	b.require(blobStorageIntegrationStatusResponseFieldProjectID)
}

// SetSyncStatus sets the SyncStatus field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetSyncStatus(syncStatus BlobStorageSyncStatus) {
	b.SyncStatus = syncStatus
	b.require(blobStorageIntegrationStatusResponseFieldSyncStatus)
}

// SetEnabled sets the Enabled field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetEnabled(enabled bool) {
	b.Enabled = enabled
	b.require(blobStorageIntegrationStatusResponseFieldEnabled)
}

// SetLastSyncAt sets the LastSyncAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetLastSyncAt(lastSyncAt *time.Time) {
	b.LastSyncAt = lastSyncAt
	b.require(blobStorageIntegrationStatusResponseFieldLastSyncAt)
}

// SetNextSyncAt sets the NextSyncAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetNextSyncAt(nextSyncAt *time.Time) {
	b.NextSyncAt = nextSyncAt
	b.require(blobStorageIntegrationStatusResponseFieldNextSyncAt)
}

// SetLastError sets the LastError field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetLastError(lastError *string) {
	b.LastError = lastError
	b.require(blobStorageIntegrationStatusResponseFieldLastError)
}

// SetLastErrorAt sets the LastErrorAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BlobStorageIntegrationStatusResponse) SetLastErrorAt(lastErrorAt *time.Time) {
	b.LastErrorAt = lastErrorAt
	b.require(blobStorageIntegrationStatusResponseFieldLastErrorAt)
}

func (b *BlobStorageIntegrationStatusResponse) UnmarshalJSON(data []byte) error {
	type embed BlobStorageIntegrationStatusResponse
	var unmarshaler = struct {
		embed
		LastSyncAt  *internal.DateTime `json:"lastSyncAt,omitempty"`
		NextSyncAt  *internal.DateTime `json:"nextSyncAt,omitempty"`
	...
	*b = BlobStorageIntegrationStatusResponse(unmarshaler.embed)
	b.LastSyncAt = unmarshaler.LastSyncAt.TimePtr()
	b.NextSyncAt = unmarshaler.NextSyncAt.TimePtr()
	b.LastErrorAt = unmarshaler.LastErrorAt.TimePtr()
	extraProperties, err := internal.ExtractExtraProperties(data, *b)
...
func (b *BlobStorageIntegrationStatusResponse) MarshalJSON() ([]byte, error) {
	type embed BlobStorageIntegrationStatusResponse
	var marshaler = struct {
		embed
		LastSyncAt  *internal.DateTime `json:"lastSyncAt,omitempty"`
...
func (b *BlobStorageIntegrationStatusResponse) String() string {
	if b == nil {
		return "<nil>"
	}
	if len(b.rawJSON) > 0 {
...
type BlobStorageSyncStatus string

const (
	BlobStorageSyncStatusIdle     BlobStorageSyncStatus = "idle"
	BlobStorageSyncStatusQueued   BlobStorageSyncStatus = "queued"
	BlobStorageSyncStatusUpToDate BlobStorageSyncStatus = "up_to_date"
	BlobStorageSyncStatusDisabled BlobStorageSyncStatus = "disabled"
	BlobStorageSyncStatusError    BlobStorageSyncStatus = "error"
)

func NewBlobStorageSyncStatusFromString(s string) (BlobStorageSyncStatus, error) {
	switch s {
	case "idle":
		return BlobStorageSyncStatusIdle, nil
	case "queued":
		return BlobStorageSyncStatusQueued, nil
	case "up_to_date":
		return BlobStorageSyncStatusUpToDate, nil
	case "disabled":
		return BlobStorageSyncStatusDisabled, nil
	case "error":
		return BlobStorageSyncStatusError, nil
	}
	var t BlobStorageSyncStatus
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (b BlobStorageSyncStatus) Ptr() *BlobStorageSyncStatus {
	return &b
}
...
var (
	...
	createBlobStorageIntegrationRequestFieldCompressed      = big.NewInt(1 << 14)
)
...
type CreateBlobStorageIntegrationRequest struct {
	...
	Compressed *bool `json:"compressed,omitempty" url:"-"`
...
// SetCompressed sets the Compressed field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateBlobStorageIntegrationRequest) SetCompressed(compressed *bool) {
	c.Compressed = compressed
	c.require(createBlobStorageIntegrationRequestFieldCompressed)
}
