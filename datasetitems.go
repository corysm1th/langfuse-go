...
type CreateDatasetItemRequest struct {
	...
	Input               any     `json:"input,omitempty" url:"-"`
	ExpectedOutput      any     `json:"expectedOutput,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateDatasetItemRequest) SetInput(input any) {
	c.Input = input
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateDatasetItemRequest) SetExpectedOutput(expectedOutput any) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateDatasetItemRequest) SetMetadata(metadata any) {
	c.Metadata = metadata
...
var (
	...
	datasetItemsListRequestFieldVersion             = big.NewInt(1 << 3)
	datasetItemsListRequestFieldPage                = big.NewInt(1 << 4)
	datasetItemsListRequestFieldLimit               = big.NewInt(1 << 5)
)
...
type DatasetItemsListRequest struct {
	...
	Version *time.Time `json:"-" url:"version,omitempty"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (d *DatasetItemsListRequest) SetVersion(version *time.Time) {
	d.Version = version
	d.require(datasetItemsListRequestFieldVersion)
}
...
type DatasetItem struct {
	...
	ExpectedOutput any           `json:"expectedOutput" url:"expectedOutput"`
...
func (d *DatasetItem) GetInput() any {
	if d == nil {
		return nil
	}
	return d.Input
...
func (d *DatasetItem) GetExpectedOutput() any {
	if d == nil {
		return nil
	}
...
func (d *DatasetItem) GetMetadata() any {
	if d == nil {
		return nil
	}
	return d.Metadata
...
// SetInput sets the Input field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (d *DatasetItem) SetInput(input any) {
	d.Input = input
...
// SetExpectedOutput sets the ExpectedOutput field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (d *DatasetItem) SetExpectedOutput(expectedOutput any) {
...
// SetMetadata sets the Metadata field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (d *DatasetItem) SetMetadata(metadata any) {
	d.Metadata = metadata
