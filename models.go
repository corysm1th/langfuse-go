...
type CreateModelRequest struct {
	...
	TokenizerConfig any `json:"tokenizerConfig,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateModelRequest) SetTokenizerConfig(tokenizerConfig any) {
...
type Model struct {
	...
	TokenizerConfig   any     `json:"tokenizerConfig" url:"tokenizerConfig"`
...
func (m *Model) GetTokenizerConfig() any {
	if m == nil {
		return nil
	}
...
// SetTokenizerConfig sets the TokenizerConfig field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (m *Model) SetTokenizerConfig(tokenizerConfig any) {
