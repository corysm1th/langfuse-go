...
) (*langfuse.MembershipsResponse, error) {
...
func (c *Client) Updateorganizationmembership(
	...
	opts ...option.RequestOption,
) (*langfuse.MembershipResponse, error) {
...
func (c *Client) Deleteorganizationmembership(
	...
	opts ...option.RequestOption,
) (*langfuse.MembershipDeletionResponse, error) {
...
func (c *Client) Getorganizationprojects(
	ctx context.Context,
	opts ...option.RequestOption,
) (*langfuse.OrganizationProjectsResponse, error) {
...
func (c *Client) Getorganizationapikeys(
	ctx context.Context,
	opts ...option.RequestOption,
) (*langfuse.OrganizationAPIKeysResponse, error) {
