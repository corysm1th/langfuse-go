...
var (
	...
	createDatasetRunItemRequestFieldDatasetVersion = big.NewInt(1 << 6)
	createDatasetRunItemRequestFieldCreatedAt      = big.NewInt(1 << 7)
)
...
type CreateDatasetRunItemRequest struct {
	...
	DatasetVersion *time.Time `json:"datasetVersion,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateDatasetRunItemRequest) SetMetadata(metadata any) {
	c.Metadata = metadata
...
// SetDatasetVersion sets the DatasetVersion field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateDatasetRunItemRequest) SetDatasetVersion(datasetVersion *time.Time) {
	c.DatasetVersion = datasetVersion
	c.require(createDatasetRunItemRequestFieldDatasetVersion)
}

// SetCreatedAt sets the CreatedAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateDatasetRunItemRequest) SetCreatedAt(createdAt *time.Time) {
	c.CreatedAt = createdAt
	c.require(createDatasetRunItemRequestFieldCreatedAt)
}
...
func (c *CreateDatasetRunItemRequest) MarshalJSON() ([]byte, error) {
	...
	var marshaler = struct {
		embed
		DatasetVersion *internal.DateTime `json:"datasetVersion,omitempty"`
		CreatedAt      *internal.DateTime `json:"createdAt,omitempty"`
	}{
		embed:          embed(*c),
		DatasetVersion: internal.NewOptionalDateTime(c.DatasetVersion),
