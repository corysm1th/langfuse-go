...
Langfuse does not publish an official Go SDK. This library has been generated from the official Langfuse OpenAPI schema and published here for convenience.

SDK releases are versioned to match the Langfuse release they were generated from. If the SDK itself changes without a corresponding Langfuse release (e.g. Makefile or README updates), a new tag will not be cut until the next Langfuse release.
