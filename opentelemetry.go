...
type OtelSpan struct {
	...
	TraceID any `json:"traceId,omitempty" url:"traceId,omitempty"`
	// Span ID (8 bytes, hex-encoded string in JSON or Buffer in binary)
	SpanID any `json:"spanId,omitempty" url:"spanId,omitempty"`
	// Parent span ID if this is a child span
	ParentSpanID any `json:"parentSpanId,omitempty" url:"parentSpanId,omitempty"`
	...
	StartTimeUnixNano any `json:"startTimeUnixNano,omitempty" url:"startTimeUnixNano,omitempty"`
	// End time in nanoseconds since Unix epoch
	EndTimeUnixNano any `json:"endTimeUnixNano,omitempty" url:"endTimeUnixNano,omitempty"`
	// Span attributes including Langfuse-specific attributes (langfuse.observation.*)
	Attributes []*OtelAttribute `json:"attributes,omitempty" url:"attributes,omitempty"`
	// Span status object
	Status any `json:"status,omitempty" url:"status,omitempty"`
...
func (o *OtelSpan) GetTraceID() any {
	if o == nil {
		return nil
	}
	return o.TraceID
...
func (o *OtelSpan) GetParentSpanID() any {
	if o == nil {
		return nil
	}
...
func (o *OtelSpan) GetStartTimeUnixNano() any {
	if o == nil {
		return nil
	}
...
func (o *OtelSpan) GetEndTimeUnixNano() any {
	if o == nil {
		return nil
	}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OtelSpan) SetTraceID(traceID any) {
	o.TraceID = traceID
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OtelSpan) SetSpanID(spanID any) {
	o.SpanID = spanID
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OtelSpan) SetParentSpanID(parentSpanID any) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OtelSpan) SetStartTimeUnixNano(startTimeUnixNano any) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OtelSpan) SetEndTimeUnixNano(endTimeUnixNano any) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OtelSpan) SetStatus(status any) {
	o.Status = status
