...
var (
	llmConnectionsDeleteRequestFieldID = big.NewInt(1 << 0)
)

type LlmConnectionsDeleteRequest struct {
	ID string `json:"-" url:"-"`
...
func (l *LlmConnectionsDeleteRequest) require(field *big.Int) {
...
func (l *LlmConnectionsDeleteRequest) SetID(id string) {
	l.ID = id
	l.require(llmConnectionsDeleteRequestFieldID)
}
...
var (
	deleteLlmConnectionResponseFieldMessage = big.NewInt(1 << 0)
)
...
func (d *DeleteLlmConnectionResponse) GetMessage() string {
	if d == nil {
		return ""
	}
	return d.Message
...
func (d *DeleteLlmConnectionResponse) GetExtraProperties() map[string]interface{} {
	if d == nil {
		return nil
	}
...
func (d *DeleteLlmConnectionResponse) require(field *big.Int) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (d *DeleteLlmConnectionResponse) SetMessage(message string) {
	d.Message = message
	d.require(deleteLlmConnectionResponseFieldMessage)
}

func (d *DeleteLlmConnectionResponse) UnmarshalJSON(data []byte) error {
	type unmarshaler DeleteLlmConnectionResponse
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*d = DeleteLlmConnectionResponse(value)
...
func (d *DeleteLlmConnectionResponse) MarshalJSON() ([]byte, error) {
	type embed DeleteLlmConnectionResponse
...
func (d *DeleteLlmConnectionResponse) String() string {
	if d == nil {
		return "<nil>"
	}
	if len(d.rawJSON) > 0 {
...
func (l *LlmConnection) GetConfig() map[string]any {
	if l == nil {
		return nil
	}
	return l.Config
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *LlmConnection) SetConfig(config map[string]any) {
	l.Config = config
...
type UpsertLlmConnectionRequest struct {
	...
	Config map[string]any `json:"config,omitempty" url:"-"`
...
// SetConfig sets the Config field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpsertLlmConnectionRequest) SetConfig(config map[string]any) {
	u.Config = config
